...
////2. модификация на (включване)отборите
...
//}
////Принтиране
// // 1. вид: отбор без членове
// //сортираме
// foreach ( var team in teams.Where(team => team.Value.Members.Count>0) // оставяме само отбори с повече от  0 членове
//                            .OrderByDescending(team=>team.Value.Members.Count)// сортираме по брой
//                            .ThenBy(team=>team.Key))// по име на отбора в нарастващ ред
// {
